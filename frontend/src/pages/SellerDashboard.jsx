...
const SellerDashboard = () => {
  ...
  const [newDish, setNewDish] = useState({ name: '', price: '', amount: '' });
  ...
  <>
    ...
    <ul style={styles.list}>
      {soldDishesDetails.length > 0 ? (
        ...
        <div style={styles.emptyState}>No sold dishes yet.</div>
      )}
    </ul>
  </>
)}

{/* Available Dishes After */}
{showAvailable && (
  <>
